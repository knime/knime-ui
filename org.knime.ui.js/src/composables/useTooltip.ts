import { watch, type Ref, onMounted, onBeforeUnmount, ref, type ComputedRef } from 'vue';
...
export const useTooltip = (params: { tooltip: ComputedRef<TooltipDefinition> }) => {
    ...
    store.watch((state) => state.workflow.tooltip, (value) => {
        if (value === null) {
    ...
    const showTooltip = () => {
        ...
        const removeWatcher = watch(params.tooltip, (value) => {
