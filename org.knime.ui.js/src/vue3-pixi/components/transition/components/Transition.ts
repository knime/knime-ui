...
export const transitionProps = {
  ...
  enter: [Function, Object, Array] as PropType<
    Hook<(el: any, done: Fn) => TransitionTicker | void>
  >,
  afterEnter: [Function, Object, Array] as PropType<Hook<(el: any) => void>>,
  enterCancelled: [Function, Object, Array] as PropType<
    Hook<(el: any) => void>
  >,
  beforeLeave: [Function, Object, Array] as PropType<Hook<(el: any) => void>>,
  leave: [Function, Object, Array] as PropType<
    Hook<(el: any, done: Fn) => TransitionTicker | void>
  >,
