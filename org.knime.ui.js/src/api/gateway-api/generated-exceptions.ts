export const KNOWN_EXECUTOR_EXCEPTIONS = ["ServiceCallException", "NetworkException", "NoSuchElementException", "InvalidRequestException", "OperationNotAllowedException", "CollisionException", ] as const;
