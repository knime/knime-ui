export const KNOWN_EXECUTOR_EXCEPTIONS = ["ServiceCallException", "NetworkException", "NoSuchElementException", "InvalidRequestException", "CollisionException", ] as const;
