...
describe('PortViewTabOutput.vue', () => {
    ...
    const doShallowMount = (props) => shallowMount(PortViewTabOutput, {
        propsData: {
            ...propsData,
            ...props
        }
    ...
    it('should emit output-state-change events when the PortViewLoader state changes', () => {
        const wrapper = doShallowMount({
            selectedPortIndex: 1
        });
        ...
        expect(wrapper.emitted('output-state-change')[1][0]).toEqual(expect.objectContaining({
