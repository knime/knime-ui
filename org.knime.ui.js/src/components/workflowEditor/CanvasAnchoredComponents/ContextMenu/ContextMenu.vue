...
const setMenuItems = () => {
  ...
  const aiActionsGroup: Array<MenuItem> = [
    ...mapToShortcut([
      {
        name: "generateWorkflowAnnotation",
        isVisible: true, // visibility dictated by the shortcut's `condition` predicate
      },
    ]),
  ];
