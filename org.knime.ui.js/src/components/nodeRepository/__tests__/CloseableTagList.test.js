...
describe('CloseableTagList.vue', () => {
    const doShallowMount = (props) => shallowMount(CloseableTagList, {
        props,
    ...
    it('renders three tags', () => {
        ...
        expect(wrapper.findComponent(SelectableTagList).props('tags')).toEqual(sevenTags);
        expect(wrapper.findComponent(SelectableTagList).props('modelValue')).toEqual(threeTags);
    });
