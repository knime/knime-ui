...
import { Button, type ButtonProps } from "@knime/kds-components";
...
const toolbarButtons = computed<Array<{ id: ShortcutName } & ButtonProps>>(
  () => {
    ...
    const variant: ButtonProps["variant"] = "transparent";
    const visibleItems: Array<
      { id: ShortcutName; visible: boolean } & ButtonProps
    > = [
      // Always visible
      {
        id: "undo",
