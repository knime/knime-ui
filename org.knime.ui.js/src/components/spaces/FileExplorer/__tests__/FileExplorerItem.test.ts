...
describe('FileExplorerItem.vue', () => {
    ...
    it('should render correctly', () => {
        ...
        expect(wrapper.find('.item-content').text()).toMatch(defaultProps.item.name);
        expect(wrapper.find('.item-content').attributes('title')).toEqual(defaultProps.item.name);
    });
    ...
    it('should forward `isDragging` and `isSelected` props', () => {
        ...
        expect(wrapper.findComponent(FileExplorerItemBase).props('isDragging')).toBe(true);
        expect(wrapper.findComponent(FileExplorerItemBase).props('isSelected')).toBe(true);
    });
