  ...
  describe("getters", () => {
    ...
    describe("node getters", () => {
      ...
      it("gets name", async () => {
        ...
        expect(store.getters["workflow/getNodeName"]("foo")).toBe(
          "exampleName"
        );
        expect(store.getters["workflow/getNodeName"]("ownData")).toBe(
          "ownName"
        );
      });
      ...
      it("gets icon", async () => {
        const { store } = await loadStoreWithWorkflow();
        expect(store.getters["workflow/getNodeIcon"]("foo")).toBe(
          "exampleIcon"
        );
        expect(store.getters["workflow/getNodeIcon"]("ownData")).toBe(
          "ownIcon"
        );
      });
      ...
      it("gets type", async () => {
        const { store } = await loadStoreWithWorkflow();
        expect(store.getters["workflow/getNodeType"]("foo")).toBe(
          "exampleType"
        );
        expect(store.getters["workflow/getNodeType"]("ownData")).toBe(
          "ownType"
        );
      });
    });
