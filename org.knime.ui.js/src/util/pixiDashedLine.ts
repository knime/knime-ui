...
export class DashLine {
  ...
  private drawDashedArc(
    ...
    // let prevPoint = getPointOnArc(cx, cy, radius, startAngle, matrix);
  ...
  //     gap = 5,
  //   ): this {
  //     const segments = 15; // Increase for smoother curves
  //     const angleStep = (endAngle - startAngle) / segments;
  //     let prevPoint = getPointOnArc(cx, cy, radius, startAngle, matrix);
  //     let draw = true;
  //     let dashLeft = dash; // Keep track of remaining dash length
