...
/**
 * Manages access to remotely supplied content such as "welcome" / "tips & tricks" / onboarding content.
 *
 */
public class ExternalContent {

    /**
     * See {@link ExternalContent}
     */
    ...
    /**
     * @return The first news item tile from the "welcome" / "home page" endpoint
     */
    public Map<String, String> getHomepageSidebarTile() {
        ...
        var firstNewsTile =
                ...
                .filter(cat -> cat.getId().equals("c1-news")) //
                .findFirst() //
