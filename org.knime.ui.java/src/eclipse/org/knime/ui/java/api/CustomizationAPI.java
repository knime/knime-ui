...
final class CustomizationAPI {
     ...
     */
    @API
    static Map<String, String> getCustomHelpMenuEntries() {
        return GatewayImplPlugin.getInstance().getCustomization().ui().getMenuEntries().stream()
            .collect(Collectors.toMap(MenuEntry::getName, MenuEntry::getLink));
    }
